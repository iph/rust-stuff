...
fn main() {
    let matches = App::new("Reader for advent")
        ...
        .arg(Arg::new("INPUT").about("Sets the input file to use").required(true).index(1))
        .get_matches();
    ...
    for puzzle in all_puzzles{
        ...
        full_accumulator *= tree_accumulator;
    }

    println!("All trees seen in all paths: {}", full_accumulator)
}
